...
describe('CreateSampleComponent', () => {
  ...
  let mockCreateSampleService;
  let mockDataService

  beforeEach(async(() => {

    mockCreateSampleService = sinon.createStubInstance(CreateSampleService);
    mockCreateSampleService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: CreateSampleService, useValue: mockCreateSampleService },
