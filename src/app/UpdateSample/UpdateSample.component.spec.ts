...
describe('UpdateSampleComponent', () => {
  ...
  let mockUpdateSampleService;
  let mockDataService

  beforeEach(async(() => {

    mockUpdateSampleService = sinon.createStubInstance(UpdateSampleService);
    mockUpdateSampleService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: UpdateSampleService, useValue: mockUpdateSampleService },
